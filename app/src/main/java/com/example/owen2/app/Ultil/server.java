...
public class server {
   ...
   // public  static  String localhost="Owenctu.000webhostapp.com";
    ...
    public  static  String Link_get_History="http://"+localhost+"/Owen2/Clients/get_history.php";
    public  static  String Link_get_Order_Detail="http://"+localhost+"/Owen2/Clients/get_order_details.php";
    public  static  String Link_get_Profile="http://"+localhost+"/Owen2/Clients/get_profile.php";
    public  static  String Link_get_Classify="http://"+localhost+"/Owen2/Clients/get_classify.php";
    public  static  String Link_get_Search="http://"+localhost+"/Owen2/Clients/get_search.php?page=";
    public  static  String Link_Check_Shopping_Card="http://"+localhost+"/Owen2/Clients/check_shopping_card.php";
    public  static  String Link_Check_Is_Exist="http://"+localhost+"/Owen2/Clients/check_is_exist.php";
    public  static  String Link_Add_To_Card="http://"+localhost+"/Owen2/Clients/add_to_card.php";
    public  static  String Link_Update_Shoppingcard="http://"+localhost+"/Owen2/Clients/update_card.php";
    public  static  String Link_Update_Name="http://"+localhost+"/Owen2/Clients/update_name.php";
    public  static  String Link_Update_Phone="http://"+localhost+"/Owen2/Clients/update_phone.php";
    public  static  String Link_Update_Address="http://"+localhost+"/Owen2/Clients/update_address.php";
    public  static  String Link_Update_Password="http://"+localhost+"/Owen2/Clients/update_password.php";
