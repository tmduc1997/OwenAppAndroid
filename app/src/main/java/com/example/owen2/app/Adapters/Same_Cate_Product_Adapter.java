...
public class Same_Cate_Product_Adapter extends BaseAdapter {

    Context context;
    ArrayList<Product> array_product2;

    public Same_Cate_Product_Adapter(Context context, ArrayList<Product> array_product2) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            view = inflater.inflate(R.layout.record_favorite_products,null);
            viewHolder.Name= view.findViewById(R.id.txt_same_cate_product_name);
            viewHolder.Price = view.findViewById(R.id.txt_same_cate_product_price);
            viewHolder.Image = view.findViewById(R.id.img_same_cate_product);
